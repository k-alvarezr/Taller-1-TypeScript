...
export var listaSeries = new Series(series);
...
function mostrarSeries(Series) {
    ...
    for (var _i = 0, _a = Series.series; _i < _a.length; _i++) {
        var serie = _a[_i];
...
function mostrarPromedio(Series) {
    var promedio = Series.darPromedioSeasons();
    var trElement = document.createElement("tr");
    trElement.innerHTML = "<td><b>Average Seasons</b></td><td>".concat(promedio, "</td>");
